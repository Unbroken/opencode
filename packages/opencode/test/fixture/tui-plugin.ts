...
function themeCurrent(): HostPluginApi["theme"]["current"] {
  ...
  return {
    ...
    syntaxLanguage: c,
    syntaxKeywordType: a,
    syntaxKeywordStorage: b,
    syntaxKeywordAccess: a,
    syntaxKeywordQualifier: e,
    syntaxBuiltinType: d,
    syntaxConstant: e,
    syntaxConstantTemplate: a,
    syntaxConstantBuiltin: e,
    syntaxConstantBuiltinPrivate: e,
    syntaxConstantTemplateFunction: a,
    syntaxCharacter: f,
    syntaxNamespace: a,
    syntaxTypeTemplate: a,
    syntaxTypeTemplateFunction: a,
    syntaxTypeAuto: a,
    syntaxFunctorParam: g,
    syntaxFunctorOutput: g,
    syntaxFunctor: c,
    syntaxFunctorMember: g,
    syntaxFunctorMemberPrivate: g,
    syntaxFunctionMember: g,
    syntaxFunctionGlobal: g,
    syntaxFunctionPrivate: g,
    syntaxParameter: c,
    syntaxParameterOutput: c,
    syntaxConcept: e,
    syntaxMember: c,
    syntaxMemberPrivate: c,
    syntaxMacro: a,
    syntaxMacroParam: a,
    syntaxGlobalStatic: c,
    syntaxGlobal: c,
    syntaxGlobalStaticPrivate: c,
    syntaxCommentDoc: b,
    syntaxCommentDocKeyword: a,
    syntaxCommentDocLink: g,
    syntaxCommentBg: h,
    syntaxCommentDocBg: h,
    styleBold: true,
    styleItalic: true,
    thinkingOpacity: 0.6,
  }
